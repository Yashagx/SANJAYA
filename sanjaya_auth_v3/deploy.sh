...
# 2.5 Force centralized DB connection to port 8000 master database
echo "AUTH_DATABASE_URL=sqlite:////home/ec2-user/sanjaya_auth_v2/sanjaya_auth.db" >> "$APP_DIR/.env"
